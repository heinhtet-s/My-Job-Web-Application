    ...
    <div className="w-full h-screen flex items-start">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center h-full p-8 ">
        <div className="mt-8 flex">
          <Link href="/login">
            <Button
              className={`flex items-center relative left-[0.7rem] px-4 py-2   rounded-lg z-100  bg-secondary z-20 hover:bg-secondaryHover `}
            >
              <span className={`mr-2  text-[#ffffff]`}>Login</span>
              <LogIn color="#ffff" />
            </Button>
          </Link>
        ...
        <div className="shadow-xl mt-8 p-12 text-center rounded-xl">
          <div className="mb-4 text-[13px] justify-center flex text-gray-600">
            Are you an employer? &nbsp; &nbsp;
            <p className="text-blue-900 text-[13px] font-[500] ">
              {" "}
              Go to Employer Register
            </p>
          </div>
          <h2 className="font-[600] mb-4 text-2xl">
            Employer Log In to Your Profile
          </h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 ">
            ...
            <Button
              type="submit"
              className="w-full bg-secondary hover:bg-secondaryHover text-white py-2 rounded "
            >
              Login
            </Button>
            <div>
