...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn(
      "[&_tr:last-child]:border-0 [&_tr:nth-child(odd)]:bg-white dark:[&_tr:nth-child(odd)]:bg-slate-800 [&_tr:nth-child(even)]:bg-[#f7e2cb] dark:[&_tr:nth-child(even)]:bg-slate-900",
      className
    )}
    {...props}
  />
